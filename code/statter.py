...
def pretty_stats(stats, p=0.999, keys=["PAL_0", "PAL", "HUTTER", "SIMPLE", "SIMPLE_0", "SMAC", "SMAC_ORD", "RANDOM"]):
...
def pretty_stats_2(stats, p=[0.95, 0.98, 0.999], keys=["PAL_0", "PAL", "HUTTER", "SIMPLE", "SIMPLE_0", "SMAC", "SMAC_ORD", "RANDOM"]):
